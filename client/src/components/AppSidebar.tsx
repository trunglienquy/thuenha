...
const AppSidebar = ({ userType }: AppSidebarProps) => {
  ...
  const navLinks =
    userType === "manager"
      ? [
          { icon: Building, label: "Căn hộ", href: "/managers/properties" },
          { icon: FileText, label: "Ứng dụng", href: "/managers/applications" },
          { icon: Settings, label: "Cài đặt", href: "/managers/settings" },
        ]
      : [
          { icon: Heart, label: "Yêu thích", href: "/tenants/favorites" },
          { icon: FileText, label: "Ứng dụng", href: "/tenants/applications" },
          { icon: Home, label: "Thuê nhà", href: "/tenants/residences" },
